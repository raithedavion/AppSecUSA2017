...
namespace WebAPI.Classes
{
    public class HMACAuthenticationAttribute : Attribute, IAuthenticationFilter
    {
        ...
        public HMACAuthenticationAttribute(IMemoryCache mem)
        {
            _cache = mem;
        ...
        {
            var DoesExist = _cache.Get(nonce);
            if (DoesExist != null)
                return true;
            ...
            var cacheEntryOptions = new MemoryCacheEntryOptions().SetAbsoluteExpiration(DateTimeOffset.UtcNow.AddSeconds(requestMaxAgeInSeconds));
            _cache.Set(nonce, requestTimeStamp, cacheEntryOptions);
